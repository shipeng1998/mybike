	...
	$('.table-sort').DataTable({
				...
				columnDefs : [{
                    ...
                    render: function(data, type, row, meta) {
                        return "<a title='编辑' href='javascript:;' onclick='bike_del("+ data +")' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a><a title='删除' href='javascript:;' onclick='bike_del(" + data +")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6e2;</i></a>"
                    }
                }]
			});
});
